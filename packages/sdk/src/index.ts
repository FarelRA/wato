...
export interface OutboundMessageRecord extends OutboundMessageRequest {
  id: string;
...
export interface WorkflowRegistryCapability {
  list(): unknown[];
...
export interface StorageEngine {
  ...
  listMessages(accountId?: string, limit?: number): MessageEnvelope[];
