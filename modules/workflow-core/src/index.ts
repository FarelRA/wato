import type { DomainEvent, StorageEngine, WatoModule, WorkflowRegistryCapability } from "@wato/sdk";
...
export const workflowCoreModule: WatoModule = {
  manifest: {
    name: "workflow-core",
    version: "0.1.0",
    kind: "core",
  ...
  register(context) {
    ...
    const workflowRegistry: WorkflowRegistryCapability = {
      list: () => [...workflows],
    ...
    context.capabilities.register("workflow-registry", workflowRegistry);
