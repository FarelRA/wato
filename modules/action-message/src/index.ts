...
export const actionMessageModule: WatoModule = {
  manifest: {
    name: "action-message",
    version: "0.1.0",
  ...
  register(context) {
    ...
    const workflowRegistry = context.capabilities.resolve<{ registerActionType?: (type: string) => void }>(capabilityNames.workflowRegistry);
