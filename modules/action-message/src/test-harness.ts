import type { ActionProvider, WorkflowDefinition } from "@wato/workflow-types";
import { actionMessageModule } from "./index.ts";
import { capabilityNames, createDomainEvent, type CapabilityRegistry, type MessageEnvelope, type ModuleContext } from "@wato/core";
...
export function actionSendInternalsTestHarness() {
  ...
  actionMessageModule.register(context);
  return { actions, sentTexts, sentMedia, forwarded, workflow, input, event };
}
