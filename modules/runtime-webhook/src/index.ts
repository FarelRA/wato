...
import type { DomainEvent, StorageEngine, WebhookDefinition, WebhookDeliveryRecord, WebhookRegistry, WatoModule } from "@wato/core";
import { capabilityNames } from "@wato/core";

export const runtimeWebhookModule: WatoModule = {
  manifest: {
